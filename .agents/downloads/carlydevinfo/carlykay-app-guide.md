...
For additional context or updates, refer to the .agents/implementation/external-app-manifests.md and .agents/implementation/app-loader-declaration-system.md documents in the repository.