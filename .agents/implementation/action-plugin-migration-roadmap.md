...
## References
- Action plugin system: `.agents/implementation/action-plugin-system.md`
- Battle room: `.agents/implementation/battle-room.md`
- Stats and effects: `.agents/implementation/stats-and-effects.md`
- Tier passive system: `.agents/implementation/tier-passive-system.md`
