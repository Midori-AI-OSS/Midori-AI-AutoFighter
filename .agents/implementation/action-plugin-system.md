...
The action plugin system provides a modular, plugin-based architecture for all combat actions in the Stained Glass Odyssey: Endless battle system. This document describes the implemented components and how to use them.
...
Track follow-up work in issue discussions and implementation notes:
- Overall migration strategy
- Plugin loader integration
- Turn loop integration milestones

## References

- Battle Logic Research: internal migration notes
