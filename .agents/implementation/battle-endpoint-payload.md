...
> These examples assume preview schema and frontend overlay updates have landed; keep documentation synchronized with the
> corresponding backend/frontend changes.
