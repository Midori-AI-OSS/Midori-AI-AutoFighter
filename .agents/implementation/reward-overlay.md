...
document before overriding `build_preview`. Keep preview schema docs aligned with backend/frontend implementation updates.

Screenshot references:

- Card preview — see `.agents/screenshots/reward-overlay-card-preview.png`.
- Relic preview — see `.agents/screenshots/reward-overlay-relic-preview.png`.
