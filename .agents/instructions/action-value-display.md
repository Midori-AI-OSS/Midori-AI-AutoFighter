...
The frontend reads the `show_action_values` flag from battle snapshots and displays values alongside portraits when enabled.
...
- [Options Menu](../instructions/options-menu.md)
