...
- Review planning documents in `.agents/planning/` and `.agents/lore/planning/` before writing notes.
- Capture clarifications and developer responses in `.agents/lore/notes/`.
